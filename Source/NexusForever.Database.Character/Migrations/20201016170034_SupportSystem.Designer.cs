...
namespace NexusForever.Database.Character.Migrations
{
    ...
    [Migration("20201016170034_SupportSystem")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NexusForever.Database.Character.Model.BugReportModel", b =>
                {
                    b.Property<ulong>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("NexusForever.Database.Character.Model.PlayerReportModel", b =>
                {
                    b.Property<ulong>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.Property<ulong>("ReportedById")
                        .HasColumnName("reportedById")
                        .HasColumnType("bigint(20) unsigned")
                        .HasDefaultValue(0ul);

                    b.Property<ulong>("ReportedPlayerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("reportedPlayerId")
                        .HasColumnType("bigint(20) unsigned")
                        .HasDefaultValue(0ul);

                    b.Property<string>("ReportedPlayerName")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("NexusForever.Database.Character.Model.SupportTicketModel", b =>
                {
                    b.Property<ulong>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("NexusForever.Database.Character.Model.BugReportModel", b =>
                {
                    b.HasOne("NexusForever.Database.Character.Model.CharacterModel", "Player")
                        .WithMany("BugReport")
            ...
            modelBuilder.Entity("NexusForever.Database.Character.Model.PlayerReportModel", b =>
                {
                    b.HasOne("NexusForever.Database.Character.Model.CharacterModel", "ReportedByPlayer")
                        .WithMany("PlayerReportBy")
